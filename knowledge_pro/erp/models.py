...
class MyUserManager(BaseUserManager):
    def create_user(self, email, first_name, middle_name, last_name, phone_number, password=None):
...
class Student(AbstractBaseUser):
    first_name = models.CharField(verbose_name='first_name', max_length=200, null=True)
    middle_name = models.CharField(verbose_name='middle_name', max_length=200, null=True)
    last_name = models.CharField(verbose_name='last_name', max_length=200, null=True)
    phone_number = models.CharField(verbose_name='phone_number', max_length=10, null=True)
    # alternative_phone_number = models.CharField(verbose_name='alternative_phone_number', max_length=10, null=True)
    roll_number = models.CharField(verbose_name='roll_number', max_length=20, null=True, unique=True)
    application_number = models.CharField(verbose_name='registration_number', max_length=20, null=True, unique=True)
